package com.cs.product.eloan.consts;

public class SC {
	public static final String SERVICE_TYPE="serviceType";
	
	public static final String ST_ACC_OEMT="acc-oemt";
	public static final String ST_ACC_OTME="acc-otme";
	public static final String ST_AMZ_OEMT="amz-oemt";
	public static final String ST_AMZ_OTME="amz-otme";
	...
	public static final String ST_STANDING_DELETE="standing-delete";
